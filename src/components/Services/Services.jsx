...
const ServicesData=[
    {
        ...
        image:Fruits1,
        title:"Fresh Fruits",
        subtitle:"lorem ipsum doldo dit amt,consectetur adipiscing elit.",
        aosDelay:"300"
    },
    {
        id:2,
  ...
  return (
    <div className='container my-16 space-y-4'>
        ...
        <div className='text-center max-w-lg mx-auto space-y-2'>
            <h1 data-aos="fade-up" className='tesxt-3xl font-bold text-dark'>Fresh and<span className='text-primary'>
                Tasty Fruits</span>{" "}
            </h1>
            <p data-aos="fade-up" data-aos-delay="300" className='text-sm opacity-50'>
                Lorem ipsum, dolor sit amet consectetur 
                adipisicing elit. Voluptatibus, 
                blanditiis. Vitae neque eos cum ipsa 
                reiciendis maiores velit ratione porro?
            </p>
        </div>
        {/* card section */}
