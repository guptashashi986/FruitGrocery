        ...
        <div className='container'>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-white'>
                ...
                <div data-aos="fade-up" className='space-y-6'>
                    <h1 className='text-4xl font-bold'>OrangeMint</h1>
                    <p className='text-sm max-w-[300px]'>
                        Lorem, ipsum dolor sit amet consectetur 
                        adipisicing elit. Possimus maxime sed aperiam 
                        perspiciatis optio doloremque nostrum ea laborum sint, at 
                        beatae nobis eligendi vitae! Molestias.
                    </p>
                </div>
